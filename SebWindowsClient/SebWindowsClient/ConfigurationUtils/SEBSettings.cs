...
namespace SebWindowsClient.ConfigurationUtils
{
	public class SEBSettings
	{
        ...
        public const String KeyKitePassword = "keyKitePassword";
        ...
        public static void CreateDefaultAndCurrentSettingsFromScratch()
		{
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyStartURL           , "https://student-pltw.kiteaai.org/TDE/logIn.htm");
			SEBSettings.settingsDefault.Add(SEBSettings.KeyStartResource           , "");
			SEBSettings.settingsDefault.Add(SEBSettings.KeySebServerURL       , "");
			SEBSettings.settingsDefault.Add(SEBSettings.KeyHashedAdminPassword, "REDACTED");
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyHashedQuitPassword , "REDACTED");
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyBrowserViewMode             , 1);
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyShowTaskBar                 , false);
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyQuitURL           , "https://student.kiteaai.org/TDE/quitSEB.htm");
            ...
            SEBSettings.settingsDefault.Add(SEBSettings.KeyKitePassword, "REDACTED");
			...
			SEBSettings.permittedProcessDataXulRunner.Add(SEBSettings.KeyIconInTaskbar  , false);
...
*/
		...
		public static void FillSettingsDictionary()
		{
			...
			foreach (KeyValue p in SEBSettings.settingsDefault)
				if (SEBSettings.settingsCurrent.ContainsKey(p.Key) == false)
				{
                    ...
                    if(p.Key != "keyKitePassword")
                    {
					SEBSettings.settingsCurrent.Add(p.Key, p.Value);
                    } else
                    {
                        //"Dont set KitePassword, it should be a default"
                    }
				}
				else
				{
		...
		public static bool StoreDecryptedSebClientSettings(byte [] sebSettings)
		{
			...
			if (sebSettings != null)
			{
				...
				try
				{
                    ...
                    Logger.AddInformation("filePassword: " + filePassword + " passwordIsHash: " + passwordIsHash);
		...
		public static bool ReadSebConfigurationFile(String fileName, bool forEditing, ref string filePassword, ref bool passwordIsHash, ref X509Certificate2 fileCertificateRef)
		{
			...
			try
			{
                ...
                Logger.AddInformation("new settings: " + newSettings.ToString());
			}
			catch (Exception streamReadException)
			{
				// Let the user know what went wrong

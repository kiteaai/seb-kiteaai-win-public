...
namespace SebWindowsClient.ConfigurationUtils
{
    ...
    public class SEBClientInfo
    {
		...
		public const string SEB_CLIENT_CONFIG = "PLTWKiteStudentPortalSettings.seb";
		public const string SEB_CLIENT_LOG = "PLTWKiteStudentPortal.log";
		private const string XUL_RUNNER_CONFIG = "config.json";
		public const string SEB_SHORTNAME = "Kite";
		...
		public const string MANUFACTURER_LOCAL     = "ATSPLTW";
        //private const string MANUFACTURER         = "ETH Zuerich";
        public const string PRODUCT_NAME           = "PLTWKiteStudentPortal";
        ...
        public const string FILENAME_SEB = "KiteStudentPortal.exe";
        public const string FILENAME_SEBCONFIGTOOL = "KiteConfigTool.exe";
        ...
        public const string BROWSER_USERAGENT_DESKTOP = "Mozilla/5.0 (Windows NT 10.0; WOW64; rv:52.0) Gecko/20100101 Kite/52.0";
        ...
        public const string BROWSER_USERAGENT_SEB = "Kite";

        public  const string END_OF_STRING_KEYWORD   = "---KITE---";
        ...
        private const int    DEFAULT_PORTNUMBER      = 57017;
        public const string  DEFAULT_KEY             = "AB𝈭l𝈖NA𝈒ah𝉇t𝈁a𝉈IAi1987";
        ...
        public const string SEB_NEW_DESKTOP_NAME     = "KiteDesktop";
        public const string SEB_WINDOWS_SERVICE_NAME = "KiteWindowsService";

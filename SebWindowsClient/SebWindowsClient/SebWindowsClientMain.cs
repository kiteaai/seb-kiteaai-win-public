...
namespace SebWindowsClient
{
	public class SingleInstanceController : WindowsFormsApplicationBase
	{
		...
		protected override void OnCreateMainForm()
		{
           ...
           // Logger.AddInformation("KeyKitePassword: " + (String)SEBClientInfo.getSebSetting(SEBSettings.KeyKitePassword)[SEBSettings.KeyKitePassword]);
            if ((String)SEBClientInfo.getSebSetting(SEBSettings.KeyKitePassword)[SEBSettings.KeyKitePassword] == "REDACTED")
            {
